...
class TopKSelection:
    def __init__(self, task, SourceTask, k, iteration, mode, files_path,
                 ...
                 weak_supervision=True, without_DA=True):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, default="battleships_ws_b_alpha=0.25")
    parser.add_argument("--seed", type=int, default=1)
    parser.add_argument("--iterations", type=int, default=10)
    parser.add_argument("--criterion", type=str, default="pagerank")
    parser.add_argument("--output_path", type=str, default="output/er_magellan/Structured/Amazon-Google/Amazon-Google/")
